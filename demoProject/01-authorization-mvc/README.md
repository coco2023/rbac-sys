refer:
1. https://github.com/auth0-samples/auth0-spring-security-api-sample/blob/master/01-Authorization/TUTORIAL.md
2. https://github.com/auth0-samples/auth0-spring-security5-api-sample/tree/master/01-Authorization-MVC
3. https://auth0.com/docs/quickstart/backend/java-spring-security5/01-authorization
    ...
    oauth2:
      resourceserver:
        jwt:
          ...
          issuer-uri: https://dev-rw4iotr2uqw68znv.us.auth0.com/
```
